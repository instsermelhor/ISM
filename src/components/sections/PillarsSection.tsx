...
const DEFAULT_PILLARS = [
  {
    ...
    kpis: [{ value: '6.5k+', label: 'Estudantes atendidos' }, { value: '142', label: 'Escolas parceiras' }],
  ...
  },
  {
    ...
    kpis: [{ value: '120k', label: 'Hectares recuperados' }, { value: '250k+', label: 'Árvores plantadas' }],
