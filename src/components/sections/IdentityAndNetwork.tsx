      ...
      <div className="py-24 container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col bg-secondary-900 rounded-2xl p-10 text-white relative overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center py-12 px-6 mb-8 relative z-10 bg-white rounded-2xl shadow-xl border border-gray-100">
              <h3 className="text-4xl lg:text-5xl font-serif italic mb-4 text-center flex gap-3">
                <span className="text-[#009C3B]">Instituto</span>
                <span className="text-[#002776]">Ser Melhor</span>
              </h3>
              <span className="text-sm uppercase tracking-[0.4em] text-brand-600 font-bold">{pageData.motto}</span>
            </div>
