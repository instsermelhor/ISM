...
const DEFAULT_DATA: HeroData = {
  ...
  subtitle: 'Somos uma organização não governamental brasileira dedicada a impulsionar transformações educacionais, sociais e ambientais. Nossa trajetória é movida pela busca contínua por redefinir as fronteiras do impacto sistêmico.',
...
export const HeroHomePage: React.FC = () => {
  ...
  const [savedVersion, setSavedVersion] = useState<HeroData>(DEFAULT_DATA);
              ...
              <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
                <Field label="Title Tag (aba do navegador)" hint="50–60 caracteres ideal">
                  ...
                  <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 10, padding: 14, marginTop: 8 }}>
                    ...
                    <div style={{ fontSize: 13, color: '#006621' }}>institutosermelhor.org</div>
