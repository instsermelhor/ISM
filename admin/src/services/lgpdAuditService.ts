...
export const LGPDChecklist: LGPDCheckItem[] = [
  ...
  },
  {
    ...
    status: 'CONFORME',
    evidence: 'Banner granular implementado em CookieConsentBanner.tsx com categorias Essenciais, Analytics, Funcionais e Marketing.',
    lastChecked: fmtDate(new Date(2026, 7, 13)),
    responsible: 'Equipe de Desenvolvimento + DPO',
  },
  {
    id: 'lgpd-003',
    ...
    status: 'CONFORME',
    evidence: 'Canal do Titular implementado em DataSubjectRightsModal.tsx com protocolo único e prazo de resposta em até 15 dias (Art. 19, II).',
    lastChecked: fmtDate(new Date(2026, 7, 13)),
    responsible: 'DPO',
  },
  {
    ...
    status: 'CONFORME',
    evidence: 'Firebase Firestore usa criptografia AES-256 em repouso por padrão (GCP). Auditado em 2026.',
    lastChecked: fmtDate(new Date(2026, 7, 10)),
  ...
  },
  {
    ...
    lastChecked: fmtDate(new Date(2026, 7, 1)),
  ...
  },
  {
    ...
    status: 'CONFORME',
    evidence: 'Documento de Política de Retenção assinado pelo Conselho em jan/2026.',
    lastChecked: fmtDate(new Date(2026, 0, 15)),
  ...
  },
  {
    ...
    legalBasis: 'Art. 16 LGPD — Término do tratamento',
    status: 'CONFORME',
    evidence: 'Serviço de anonimização e expiração de dados pessoais ativo com criptografia irreversível e logs auditáveis.',
    lastChecked: fmtDate(new Date(2026, 7, 13)),
    responsible: 'Infraestrutura + DPO',
  },
  {
    id: 'lgpd-008',
