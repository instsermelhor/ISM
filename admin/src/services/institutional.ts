...
const SEED_PAGE: InstitutionalPageData = {
  ...
  introduction: 'Somos uma organização da sociedade civil brasileira que atua como catalisadora de transformações sociais, ambientais, educacionais e culturais, comprometida com a garantia de direitos, o desenvolvimento sustentável e o protagonismo das comunidades.',
