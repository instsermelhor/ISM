...
export const SuperAdminAuditService = {
  generateAuditReport: (): PlatformAuditReport => {
    return {
      ...
      superAdmins: ['ribeiro.rikardo@gmail.com'],
      auditedUsers: [
        {
          ...
          isOrphan: false,
          notes: 'Super Usuário Universal. Troca obrigatória de senha ativa para o primeiro acesso.',
        },
        {
          id: '0_admism',
          ...
          conflictingPermissions: false,
          isOrphan: false,
          notes: 'Conta de serviço mantida no firestore.rules para bootstrap de emergência.',
        },
        {
          id: '0_gmail',
          ...
          conflictingPermissions: false,
          isOrphan: false,
          notes: 'Conta secundária mantida com privilégios de ADMIN.',
        },
        {
          id: '1',
